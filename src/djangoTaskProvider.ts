...
export class DjangoTaskProvider implements vscode.TaskProvider {
	...
	public resolveTask(_task: vscode.Task): vscode.Task | undefined {
		...
		if (task) {
			...
			return new vscode.Task(definition, _task.scope ?? vscode.TaskScope.Workspace, definition.task, 'django', new vscode.ShellExecution(`${pythonPath} ${pythonFile} ${definition.task} ${args}`));
		}
		return undefined;
	}
}
